...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<div class="ui input" style="margin-bottom: 10px;"><input type="search" class="'+classes.sFilterInput+'"/></div>';
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var select = $('<select/>', {
			...
			'class':         classes.sLengthSelect+'ui compact dropdown'
		} );
	...
	$.extend( DataTable.ext.classes, {
		"sTable": "ui table striped",
		"sNoFooter": "no-footer",
	
		/* Paging buttons */
		"sPageButton": "item items",
		...
		"sPaging": "ui right floated pagination menu paging_", /* Note that the type is postfixed */
