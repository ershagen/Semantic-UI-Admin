...
?>
	       ...
	       <h2>Beställningar</h2>
			...
			<div class="ui segment" style="box-shadow: none;">
				<div class="ui breadcrumb">
				  ...
				  <a data-tab="orders2" class="section tab-itemer">Beställningar</a>
				  <i class="right chevron icon divider"></i>
	    ...
	    <div class="ui segment" style="box-shadow: none;">
					...
					<form action="http://valfrimobil.se/edit_order.php" method="post" id="orderedit" class="ui form">
...
<input id="order_id" name="order_id" type="hidden" value="<?php echo $id; ?>">
								...
								<div class="field required">
									...
									<input placeholder="" title="Fyll i en e-postadress" id="email" name="email" type="text" value="<?php echo $email; ?>" required>
								...
								<div class="field required">
									...
									<input placeholder="" title="Fyll i ett org.nr" id="lastname" name="lastname" type="text" value="<?php echo $lastname; ?>" required>
								...
								<div class="field required">
									...
									<input placeholder="" value="<?php echo $number; ?>" id="number" title="Fyll i ett nummer" name="number" type="text" required>
