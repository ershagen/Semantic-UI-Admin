...
$productid = $productid_state->fetchAll(PDO::FETCH_ASSOC);
    ...
    '.(($produ['code']=='1')?'
			...
			<form class="code-form-latest" id="'.$row['order_id'].'" method="post">
									<div class="ui form" style="position: relative;">
									
										<input type="text" style="width: 100px; margin-bottom: 5px;" placeholder="Kod (Sparas)" value="'.$row['code'].'" class="code_code'.$row['order_id'].'" name="code_code">
